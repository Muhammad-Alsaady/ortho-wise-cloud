...
const translations: Record<string, Record<Language, string>> = {
  ...
  'doctor.tabQueue': { en: 'Queue', ar: 'قائمة الانتظار' },
  'doctor.tabAppointments': { en: 'My Appointments', ar: 'مواعيدي' },
  'doctor.noAppointments': { en: 'No appointments for today', ar: 'لا توجد مواعيد لهذا اليوم' },
  ...
  'payment.appointmentFeeLabel': { en: 'Appointment Fee', ar: 'رسوم الموعد' },
  'payment.appointmentFeePaid': { en: 'Appointment fee payment', ar: 'دفعة رسوم الموعد' },
